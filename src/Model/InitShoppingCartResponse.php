...
class InitShoppingCartResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'InitShoppingCartResponse';
    ...
    */
    ...
    public function setShopOrderId(string $shop_order_id): static
    {
        ...
        if ((mb_strlen($shop_order_id) > 18)) {
            throw new InvalidArgumentException('invalid length for $shop_order_id when calling InitShoppingCartResponse., must be smaller than or equal to 18.');
        }
        if ((mb_strlen($shop_order_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $shop_order_id when calling InitShoppingCartResponse., must be bigger than or equal to 1.');
        }
