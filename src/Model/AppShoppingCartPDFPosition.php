...
class AppShoppingCartPDFPosition implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AppShoppingCartPDFPosition';
    ...
    */
     ...
     */
    public function getPosition(): \kruegge82\DPIM\Model\VoucherPosition
    {
     ...
     * @return $this
     */
    public function setPosition(\kruegge82\DPIM\Model\VoucherPosition $position): static
    {
        if (is_null($position)) {
