...
class ContractProduct implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ContractProduct';
    ...
    */
     ...
     * Sets product_code
     *
     * @param int|null $product_code The product code.
     *
     * @return $this
     */
    public function setProductCode(?int $product_code): static
    {
        ...
        if (($product_code < 1)) {
            throw new InvalidArgumentException('invalid value for $product_code when calling ContractProduct., must be bigger than or equal to 1.');
        }
