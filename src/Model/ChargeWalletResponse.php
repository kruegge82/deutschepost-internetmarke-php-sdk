...
class ChargeWalletResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ChargeWalletResponse';
    ...
    */
     ...
     * Sets shop_order_id
     *
     * @param string $shop_order_id The order number in the shop. All characters are allowed except < and &.
     *
     * @return $this
     */
    public function setShopOrderId(string $shop_order_id): static
    {
        ...
        if ((mb_strlen($shop_order_id) > 18)) {
            throw new InvalidArgumentException('invalid length for $shop_order_id when calling ChargeWalletResponse., must be smaller than or equal to 18.');
        }
        if ((mb_strlen($shop_order_id) < 1)) {
            throw new InvalidArgumentException('invalid length for $shop_order_id when calling ChargeWalletResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets wallet_balance
     *
     * @param int|null $wallet_balance The new balance.
     *
     * @return $this
     */
