...
class Configuration
{
     ...
     * @var string
     */
    protected string $host = 'https://api-eu.dhl.com/post/de/shipping/im/v1';
    ...
    {
        $report  = 'PHP SDK (kruegge82\DPIM) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.26' . PHP_EOL;
