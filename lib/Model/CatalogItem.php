...
class CatalogItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'category_id' => 'int',
        'images' => '\kruegge82\DPIM\Model\ImageItem[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['category_description'] === null) {
            $invalidProperties[] = "'category_description' can't be null";
        }
     ...
     *
     * @param string $category_description The description of the motif category.
     *
     * @return self
     */
     ...
     * Sets category_id
     *
     * @param int|null $category_id The ID of the motif category.
     *
     * @return self
     */
     ...
     * Gets images
     *
     * @return \kruegge82\DPIM\Model\ImageItem[]
     */
     ...
     * Sets images
     *
     * @param \kruegge82\DPIM\Model\ImageItem[] $images The list of image items.
     *
     * @return self
     */
