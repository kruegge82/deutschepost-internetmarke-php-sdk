...
class AppShoppingCartPDFRequest extends AppCheckoutPDFRequest
{
    ...
    protected static $openAPITypes = [
        ...
        'dpi' => 'string',
        'page_format_id' => 'int',
        'positions' => '\OpenAPI\Client\Model\AppShoppingCartPDFPosition[]'
    ];
    ...
    */
     ...
     * Gets positions
     *
     * @return \OpenAPI\Client\Model\AppShoppingCartPDFPosition[]
     */
     ...
     * Sets positions
     *
     * @param \OpenAPI\Client\Model\AppShoppingCartPDFPosition[] $positions List of PDF order items. At least one item has to be specified.
     *
     * @return self
     */
