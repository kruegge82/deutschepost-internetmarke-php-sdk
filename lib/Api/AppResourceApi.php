...
class AppResourceApi
{
     ...
     * @return \OpenAPI\Client\Model\ChargeWalletResponse|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\Error401Response|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\Error429Response|\OpenAPI\Client\Model\RequestStatus
     */
    ...
    public function chargeWalletWithHttpInfo($amount, string $contentType = self::contentTypes['chargeWallet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ChargeWalletResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ChargeWalletResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ChargeWalletResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\OpenAPI\Client\Model\RequestStatus' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\RequestStatus' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\RequestStatus', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
                    if ('\OpenAPI\Client\Model\Error401Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\Error401Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\Error401Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
                ...
                case 429:
                    if ('\OpenAPI\Client\Model\Error429Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\Error429Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\Error429Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 500:
            ...
            $returnType = '\OpenAPI\Client\Model\ChargeWalletResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ChargeWalletResponse',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\RequestStatus',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\Error401Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 429:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\Error429Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function checkoutShoppingCartPDFAppWithHttpInfo($checkout_shopping_cart_pdf_app_request, $validate = false, $finalize = false, $directCheckout=false, string $contentType = self::contentTypes['checkoutShoppingCartPDFApp'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CheckoutShoppingCartAppResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CheckoutShoppingCartAppResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CheckoutShoppingCartAppResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CheckoutShoppingCartAppResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkoutShoppingCartPNGAppAsync($checkout_shopping_cart_png_app_request, $validate = false, $finalize = false, string $contentType = self::contentTypes['checkoutShoppingCartPNGApp'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkoutShoppingCartPNGAppAsyncWithHttpInfo($checkout_shopping_cart_png_app_request, $validate = false, $finalize = false, string $contentType = self::contentTypes['checkoutShoppingCartPNGApp'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CheckoutShoppingCartAppResponse';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function checkoutShoppingCartPNGAppRequest($checkout_shopping_cart_png_app_request, $validate = false, $finalize = false, string $contentType = self::contentTypes['checkoutShoppingCartPNGApp'][0])
    {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\InitShoppingCartResponse|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\Error401Response|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\Error429Response|\OpenAPI\Client\Model\RequestStatus
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\InitShoppingCartResponse|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\Error401Response|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\Error429Response|\OpenAPI\Client\Model\RequestStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function initShoppingCartAppWithHttpInfo(string $contentType = self::contentTypes['initShoppingCartApp'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\InitShoppingCartResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InitShoppingCartResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\InitShoppingCartResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\InitShoppingCartResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\InitShoppingCartResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \OpenAPI\Client\Model\RetoureVouchersRequest $retoure_vouchers_request retoure_vouchers_request (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\RetoureVouchersResponse|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\Error429Response|\OpenAPI\Client\Model\RequestStatus
     */
     ...
     * Retoure vouchers For App.
     *
     * @param  \OpenAPI\Client\Model\RetoureVouchersRequest $retoure_vouchers_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['retoureVouchersApp'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\RetoureVouchersResponse|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\Error429Response|\OpenAPI\Client\Model\RequestStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function retoureVouchersAppWithHttpInfo($retoure_vouchers_request, string $contentType = self::contentTypes['retoureVouchersApp'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\RetoureVouchersResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\RetoureVouchersResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\RetoureVouchersResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\RetoureVouchersResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\RetoureVouchersResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\RetrieveCatalogResponse|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\Error401Response|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\Error429Response|\OpenAPI\Client\Model\RequestStatus
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\RetrieveCatalogResponse|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\Error401Response|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\Error429Response|\OpenAPI\Client\Model\RequestStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveCatalogAppWithHttpInfo($types, string $contentType = self::contentTypes['retrieveCatalogApp'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\RetrieveCatalogResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\RetrieveCatalogResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\RetrieveCatalogResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\RetrieveCatalogResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\RetrieveCatalogResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $shop_retoure_id The shopRetoureId was returned from the retoure Vouchers request. (optional)
     * @param  int $retoure_transaction_id Internal transaction number under which the refund was booked in the PCF. (optional)
     * @param  \DateTime $start_date The start date of the search. Expected format: yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSXXX. (optional)
     * @param  \DateTime $end_date The end date of the search. Expected format: yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSXXX. (optional)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\RetrieveRetoureStateResponse|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\Error429Response|\OpenAPI\Client\Model\RequestStatus
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\RetrieveRetoureStateResponse|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\Error429Response|\OpenAPI\Client\Model\RequestStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveRetoureStateAppWithHttpInfo($shop_retoure_id = null, $retoure_transaction_id = null, $start_date = null, $end_date = null, string $contentType = self::contentTypes['retrieveRetoureStateApp'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\RetrieveRetoureStateResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\RetrieveRetoureStateResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\RetrieveRetoureStateResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\RetrieveRetoureStateResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\RetrieveRetoureStateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CheckoutShoppingCartAppResponse|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\Error401Response|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\RequestStatus|\OpenAPI\Client\Model\Error429Response|\OpenAPI\Client\Model\RequestStatus
     */
